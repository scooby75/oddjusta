...
def mostrar_resultados(team_type, time, odds_column, odds_group):
    ...
    st.write("### Partidas Filtradas:")
    st.write(team_df)

    # Calcular e exibir placares mais frequentes
    st.write("### Placares Mais Frequentes:")
    placares_frequentes = team_df['Placar'].value_counts().head(5)
    st.write(placares_frequentes)
