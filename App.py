...
# Create an empty DataFrame to store the general database
...
for file_path in file_paths:
    try:
        ...
        # Remove duplicate entries based on 'Data', 'Home', and 'Away' columns
        df.drop_duplicates(subset=['Data', 'Home', 'Away'], inplace=True)

        # Append data to the general DataFrame
